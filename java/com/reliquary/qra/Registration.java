...
public class Registration extends Activity implements QRCodeReaderView.OnQRCodeReadListener, AdapterView.OnItemClickListener {

    private QRCodeReaderView mydecoderview;
    private ArrayList<String> check,errorCheck;
...
///////////////////////////////////////COLLECTING SPLITTED PARTS IN VARIABLES////////////////////////////////////////////
                ...
                String tablename = tablename(initYear, curYear, curMonth, brCode);
///
// ///////////////////////////////////INSERTION IN COMMON DATABASE////////////////////////////////////////////////////////////////
                try {
                    String sql = "INSERT INTO commonReg (roll) VALUES('" + rollNumber + "')";
                    db.execSQL(sql);

                } catch (Exception e) {
                    ////////////////////////////////////////////EXCEPTION CHECK two//////////////////////////////////////
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Exception Check two"+e.toString());
                    builder.show();
                    Toast.makeText(this, "" + e.toString(), Toast.LENGTH_LONG).show();
                    errorList(e.toString());
                }
/////////////////////////////////////////////INSERTION IN SPECIFIC DATABASE/////////////////////////////////////////////////////////////



                if (isTableExists(db, tablename)) {
                    try {
                        String sql = "INSERT INTO " + tablename + " (Roll_Number ,Total_Attendance ,Period_1 ,Period_2 ,Period_3 ,Period_4,Period_5 ,Period_6 ,Period_7) VALUES('" + rollNumber + "','" + 0 + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "')";
                        db.execSQL(sql);
  //                      Toast.makeText(this, "DONE directly", Toast.LENGTH_LONG).show();
                        sucessSound();

                    } catch (Exception e) {
                        ////////////////////////////////////////////EXCEPTION CHECK THREE//////////////////////////////////////
                        AlertDialog.Builder builder = new AlertDialog.Builder(this);
                        builder.setMessage("Exception Check THREE"+e.toString());
                        builder.show();
                        Toast.makeText(this, "" + e.toString(), Toast.LENGTH_LONG).show();
                        errorList(e.toString());
                    }
                } else {
                    runtimeDatabse(tablename);
                }
            }
...
///////////////////////////////////////////////////LIST ITEM CLICK/////////////////////////////////////////////////
    ...
    public void runtimeDatabse(String Table_Name)
    {
        ...
        try {
            String sql = "INSERT INTO " + Table_Name + " (Roll_Number ,Total_Attendance ,Period_1 ,Period_2 ,Period_3 ,Period_4,Period_5 ,Period_6 ,Period_7) VALUES('" + rollNumber + "','" + 0 + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "')";
            db.execSQL(sql);
